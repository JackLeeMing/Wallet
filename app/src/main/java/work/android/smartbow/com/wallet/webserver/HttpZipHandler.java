...
public class HttpZipHandler extends BaseHander {
	...
	@Override
	public void handleLocale(HttpRequest request, HttpResponse response,
			HttpContext context) throws HttpException, IOException {

		target = target.substring(0,target.length() - WebServer.SUFFIX_ZIP.length());
